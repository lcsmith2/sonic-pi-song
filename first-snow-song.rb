...
# 12/10/22
#
# This file contains Sonic Pi code for a relaxing song titled First Snow.


# Plays the specified sequence of notes with the given opts and delay.
#
# Parameters:
#   sequence: the list of notes/chords to play
#   attack_time: the value for the attack opt
#   release_time: the value for the release opt
#   amp_val: the value for the amp opt
#   delay: how long to sleep after playing a note/chord in the sequence
